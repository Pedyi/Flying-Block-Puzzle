...
.
├── All codes/
│   ├── CBHA_Star.py   # CBHA* — seven-class algorithm with class-conditional heuristics and tie-breaking
│   ├── SA_Star.py                      # Standard A* (SA*) with general heuristic
│   ├── DPA_Star.py                      # Depth-Prioritized A* (DPA*)
...
python "All codes/CBHA_Star.py"

# Run Depth-Prioritized A*
python "All codes/DPA_Star.py"

# Run Standard A*
python "All codes/SA_Star.py"
...
(echo 10; cat "Test case/H_B(Test case)/n = 10/# goal piece - # vacant unit = 1/Goal_piece(I) = 3/Vertical distance = 4/1_Frame.txt"; cat "Test case/H_B(Test case)/n = 10/# goal piece - # vacant unit = 1/Goal_piece(I) = 3/Vertical distance = 4/1_Goal.txt") | python "All codes/CBHA_Star.py"
```
